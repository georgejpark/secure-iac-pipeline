# ---------------------------------------------------------------------------
# Environment: prod
# Production. Regulated claims data. Every control on, multi-AZ,
# 30 days of backups, deletion protection non-negotiable.
#
...
terraform {
  ...
  # backend "s3" {
  #   bucket         = "tm-terraform-state-prod"
  #   key            = "claims-platform/prod/terraform.tfstate"
  #   region         = "us-east-2"
  #   encrypt        = true
