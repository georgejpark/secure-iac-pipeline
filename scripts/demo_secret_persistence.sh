...
# after all three.
#
# Safe to run anywhere. NOTE: the credential variable names are deliberately
# neutral -- macOS endpoint protection quarantines this file when they are the
# real AWS ones. The canonical copy on the Proxmox host uses AWS_ names.
#
